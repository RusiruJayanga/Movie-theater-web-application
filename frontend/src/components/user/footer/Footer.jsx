...
const Footer = () => {
  return (
    <footer className="w-[100%] bg-[#1a1a1a] text-[#bdbdbd] font-light relative bottom-0 mt-[250px] p-[10px] pt-[30px] cursor-default ">
      <div className="w-[100%] flex flex-wrap justify-center gap-[20px] ">
        ...
        <div className="w-[250px] xl:w-[300px]">
          <h5 className="text-[#f21f30]">US</h5>
          <p className=" hover:text-white transition duration-300 ease-out ">
        ...
        <div className="w-[100px] flex flex-col gap-[5px] md:w-[150px] xl:w-[200px]">
          <h5 className="text-[#f21f30]">QUICK LINKS</h5>
          <p
            className=" hover:text-white transition duration-300 ease-out mt-[5px]"
            href="#home"
          >
            Home
          </p>
          <p
            className=" hover:text-white transition duration-300 ease-out"
            href="#new"
          >
            New
          </p>
        ...
        <div className="xl:w-[300px] flex flex-col gap-[5px]">
          <h5 className=" text-[#f21f30]">CONTACT US</h5>
          <p className=" hover:text-white transition duration-300 ease-out ">
            Gmail: amc@gmail.com
          </p>
          <p className=" hover:text-white transition duration-300 ease-out ">
          ...
          <ul className="flex gap-[10px] mt-[10px] xl:gap-[15px]">
            <a href="#">
              <i className="bi bi-facebook hover:text-white transition duration-300 ease-out"></i>
            </a>
            <a href="#">
              <i className="bi bi-instagram hover:text-white transition duration-300 ease-out"></i>
            </a>
            <a href="#">
              <i className="bi bi-twitter-x hover:text-white transition duration-300 ease-out"></i>
            </a>
            <a href="#">
              <i className="bi bi-linkedin hover:text-white transition duration-300 ease-out"></i>
            </a>
          </ul>
        </div>
      </div>
