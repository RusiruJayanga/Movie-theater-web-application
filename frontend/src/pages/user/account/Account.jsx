...
const Account = () => {
  return (
    <div className="p-[10px] flex flex-col items-start text-white cursor-default md:w-[80%] md:mx-auto xl:w-[60%]">
      <div className="w-[100%] flex items-center justify-between p-[20px] border-t-[1px] border-b-[1px] border-gray-600 mt-[40px] ">
        <img
        ...
        <div className="mr-auto ml-[20px]">
          ...
          <h3 className="text-[#f21f30] uppercase font-medium ">
            Rusiru Jayanga
          </h3>
        </div>
        <h4 className="w-[40px] h-[40px] flex items-center justify-center text-white cursor-pointer hover:text-[#f21f30] transition-colors duration-300 ease-out">
          <i className="bi bi-box-arrow-right"></i>
        </h4>
      </div>
      <div className="w-[100%] flex flex-col items-start mt-[100px] xl:mt-[150px] text-white font-light ">
