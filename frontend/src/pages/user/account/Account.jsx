    ...
    <div className="p-[10px] flex flex-col items-start text-white cursor-default mt-[40px] md:w-[80%] md:mx-auto xl:w-[60%] xl:mt-[20px] ">
      ...
      <div className="w-[100%] flex flex-col items-start mt-[100px] xl:mt-[150px] font-light ">
        ...
        <div
          ...
          } flex w-[100%] items-center justify-start p-[20px] border-t-[1px] border-b-[1px] border-gray-800 cursor-pointer opacity-[0.8] hover:opacity-[1] transition-opacity duration-300 ease-out `}
        >
          <p className="w-[150px] uppercase ml-[40px] md:w-[300px] ">
            Movie Title
          </p>
          <h5 className="ml-[40px] text-[#f21f30] uppercase font-bold">PG</h5>
          <h5 className="opacity-[0.8] uppercase ml-auto">1 h 35 min</h5>
        </div>
        {/* repeat */}
